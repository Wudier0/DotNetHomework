...
namespace OrderSystemWinForm
{
    public partial class MainForm : Form
    {
        ...
        public void InitOrders()
        {
            ...
            Goods good1 = new Goods("egg", 2.5);
            Goods good2 = new Goods("milk", 5.5);
            Goods good3 = new Goods("meat", 15.5);
            Goods good4 = new Goods("fish", 10.5);
            Goods good5 = new Goods("tomato", 4.5);
            OrderDetails order1Detail1 = new OrderDetails(1, good1, 50);
            OrderDetails order1Detail2 = new OrderDetails(2, good2, 20);
            OrderDetails order2Detail1 = new OrderDetails(1, good3, 12);
            OrderDetails order2Detail2 = new OrderDetails(2, good4, 15);
            OrderDetails order2Detail3 = new OrderDetails(3, good5, 22);
            Order order1 = new Order(1, customer1);
            order1.Details.Add(order1Detail1);
            order1.Details.Add(order1Detail2);
            Order order2 = new Order(2, customer2);
            order2.Details.Add(order2Detail1);
            order2.Details.Add(order2Detail2);
            order2.Details.Add(order2Detail3);
            ...
            using (var context = new OrderContext())
            {
                ...
                context.Details.Add(order1Detail1);
                context.Details.Add(order1Detail2);
                context.Details.Add(order2Detail1);
                context.Details.Add(order2Detail2);
                context.Details.Add(order2Detail3);
                context.SaveChanges();
            }
        }
